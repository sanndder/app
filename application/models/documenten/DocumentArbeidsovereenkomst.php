 ...
 *
 */
class DocumentArbeidsovereenkomst extends Document implements DocumentInterface {
	 ...
	 * @return object|boolean
	 */
	public function _addFormulierLoonheffingen( $pdfObject )
	{
		$loonheffingen = new DocumentModelLoonheffingen();
		$pdfLoonheffingen = $loonheffingen->werknemer( $this->_werknemer_id )->pdf();
		
		Pdf::Merge($pdfLoonheffingen->path(), $pdfObject->path(), $pdfObject->path() );
