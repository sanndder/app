...
<div class="page-content">
	...
	<div class="content-wrapper">
		...
		<div class="content d-flex justify-content-center align-items-center">
			...
			<!-- Login form -->
			<form method="post" class="login-form" action="" style="width:350px;">
				<div class="card mb-0">
					<div class="card-body">
						<div class="text-center mb-3">
							...
							<h5 class="mb-0">Abering Online</h5>


						<i class="icon-hammer-wrench mt-4 icon-3x""></i><br />
							<h5 class="mb-0">
								Wij zijn korte tijd gesloten voor onderhoud
							</h5>
						</div>
					</div>
				</div>
