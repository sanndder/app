								...
								<fieldset class="mb-3">
									...
									<div class="form-group row">
										...
										<div class="col-xl-{$div_xl} col-md-{$div_md}">
											<input value="{$smarty.get.user_type|default:'werkgever'}" name="user_type" type="text" class="form-control" readonly>
										</div>
									</div>

									<div class="form-group row">
										<label class="font-weight-bold col-lg-{$label_lg} col-form-label">{$smarty.get.user_type|default:'werkgever'|ucfirst}*:</label>
										<div class="col-xl-{$div_xl} col-md-{$div_md}">
											<input value="{$user_data.bedrijfsnaam|default:$bedrijfsnaam}" type="text" class="form-control" readonly>
										</div>
									</div>
                                    ...
                                    {if isset($formdata.username)}
										...
										<div class="form-group row">
											...
											<div class="col-xl-{$div_xl} col-md-{$div_md}">
												<input value="{if $formdata.$field.value != ''}{$formdata.$field.value}{else}{$user_data.email|default:''}{/if}" name="{$field}" type="text" class="form-control {if isset($formdata.$field.error)}border-danger{/if}" placeholder="" autocomplete="off" required>
