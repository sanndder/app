...
function content_5d4b3275e1b858_79712450 (Smarty_Internal_Template $_smarty_tpl) {
?>	<!-- Main sidebar -->
...
" class="nav-link <?php if ($_smarty_tpl->tpl_vars['active']->value == 'facturen') {?>active<?php }?>">
							...
							<!-- li Inleners -->
							<li class="nav-item">
								<a href="crm/inleners/dossier/inleners/<?php echo $_smarty_tpl->tpl_vars['inlener']->value->inlener_id;?>
