...
{block "content"}
	...
	{include file='crm/werknemers/dossier/_sidebar.tpl' active='contactpersonen'}
	{include file='crm/werknemers/dossier/modals/contactpersonen.tpl'}
							...
							<div class="card-body">
								...
								<div class="row">
									...
									<div class="col-md-1 text-right">
										<button data-title="Contact persoon wijzigen" data-id="{$contact.contact_id}" type="button" class="btn btn-outline-info btn-icon rounded-round ml-1" onclick="modalContact(this, 'werknemer', {$werknemer->werknemer_id})" data-popup="tooltip" data-placement="top">
