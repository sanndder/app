...
{block "content"}
	...
	{include file='crm/zzp/dossier/_sidebar.tpl' active='notities'}
							...
							<div class="navbar navbar-light bg-light navbar-expand-sm py-header rounded-top">
								...
								<div class="navbar-collapse text-center text-lg-left flex-wrap collapse show" id="inbox-toolbar-toggle-read">
									<div class="mt-3 mt-lg-0 mr-lg-3">
										<div class="btn-group">
											<button type="button" class="btn btn-light btn-sm" data-id="0" onclick="modalContact(this, 'werknemer', {$zzp->zzp_id})">
					...
					<div class="card border-left-3 border-left-blue-400 rounded-left-0 mb-2">
						<div class="card-body">
							<div class="d-sm-flex align-item-sm-center flex-sm-nowrap">
								<div>
									<p class="mb-0">Werknemer geeft aan dat hij NIET gebeld wil worden, alleen emailen.	</p>
								</div>
							</div>
						</div>
