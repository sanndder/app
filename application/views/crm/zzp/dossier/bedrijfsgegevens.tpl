...
{block "content"}
    ...
    {include file='crm/zzp/dossier/_sidebar.tpl' active='bedrijfsgegevens'}
						...
						<div class="card-body">
							...
							<form method="post" action="">
								...
								<div class="row">
                                    ...
                                    {* geschiedenis alleen wanneer ZZP'er compleet *}
                                    {if $zzp->complete == 1}
										<div class="col-lg-5 text-right mb-3">
											<span data-title="Wijzigingen weergeven" data-popup="tooltip" data-placement="top" style="cursor:pointer;" onclick="showHistory('zzp_bedrijfsgegevens', 'zzp_id', {$zzp->zzp_id} )">
												<i class="icon-history mr-2" style="font-size: 22px"></i>
											</span>
										</div>
                                    {/if}
                                    {if $ENV == 'development' || $user_id == 2}
										<div class="col-lg-1 text-right mb-3">
                                ...
                                {* bij nieuwe zzper ook uitzender kiezen, alleen als werkgever *}
